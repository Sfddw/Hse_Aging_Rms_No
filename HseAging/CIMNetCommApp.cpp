...
BOOL CCimNetCommApi::ERCP()
{
	...
	//m_strERCP.Format(_T("ERCP ADDR=W4.G1.E3.RMS,W4.G3.W4AMAL01MH.UPLOADER EQP=W4ASY1010 MACHINE=W4AMAL01MH UNIT=W4AMAL01MH01 RCS=H MODE_CODE=N MODEL=LP160WU3-SPB2-KH1-B BASEMODEL= WODR=25BLM001N-FA07 CATEGORY=PROD RECIPE= RECIPEVER= OPER= NW_CD= NW_DESCRIPTION=[] CHANGE_TYPE=B VALIDATIONINFO=[]"),
	//m_strERCP.Format(_T("ERCP ADDR=W4.G1.E3.RMS,W4.G3.W4AMAL01MH.UPLOADER EQP=W4ASY1010 MACHINE=W4AMAL01MH UNIT=W4AMAL01MH01 RCS=H MODE_CODE=N MODEL=LP160WU3-SPB2-KH1-B BASEMODEL= WODR=25BLM001N-FA07 CATEGORY=PROD REPLY_REQ=Y TO_EQP= MMC_TXN_ID=20251107013035"),
	
	//m_strERCP.Format(_T("EAYT ADDR=%s,%s EQP=%s NAME=%s REPLY_REQ=Y TO_EQP= MMC_TXN_ID="),
	m_strERCP.Format(_T("ERCP ADDR=%s,%s EQP=W4ASY1010 RCS=H MODE_CODE=N MODEL= BASEMODEL= CATEGORY= RECIPE= RECIPEVER= OPER= NW_CD= NW_DESCRIPTION=[] CHANGE_TYPE=B VALIDATIONINFO=[VALIDATIONINFO=[] UNIT_INFO=[%s:[7]:U:1:3:%s:0:[MODEL_NB#7^02MH01_D10000#LP140WU4-SPBA^02MH01_D10028#1^02MH01_D10029#1^02MH01_D10030#16391^02MH01_D10031#7^02MH01_D10032#3^02MH01_D10034#7^02MH01_D10035#3^02MH01_D10036#15^02MH01_D10037#7^02MH01_D10038#3^02MH01_D10039#15^02MH01_D10040#3^02MH01_D10041#3^02MH01_D10042#3^02MH01_D10043#1^02MH01_D10044#7^02MH01_D10045#15^02MH01_D10046#7^02MH01_D10047#7^02MH01_D10048#13^02MH01_D10049#3^02MH01_D10050#3^02MH01_D10051#3^02MH01_D10052#7^02MH01_D10053#7^02MH01_D10100#40.5^02MH01_D10102#40^02MH01_D10104#74.2]] REPLY_REQ=Y TO_EQP= MMC_TXN_ID="),
	
	//m_strERCP.Format(_T("ERCP ADDR=%s,%s EQP=W4ASY1010 MACHINE=%s UNIT=%s RCS=H MODE_CODE=N MODEL=LP160WU3-SPB2-KH1-B BASEMODEL= WODR=25BLM001N-FA07 CATEGORY=PROD RECIPE= RECIPEVER= OPER= NW_CD= NW_DESCRIPTION=[] CHANGE_TYPE=B VALIDATIONINFO=[]"),
		...
		m_strRemoteSubjectRMS, // REMOTE SUBJECT
		m_strLocalSubjectRMS, // LOCAL SUBJECT

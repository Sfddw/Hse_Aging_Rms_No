...
BOOL CCimNetCommApi::ERCP()
{
	...
	/*m_strERCP.Format(_T("ERCP ADDR=%s,%s EQP=W4ASY1010 RCS=H MODE_CODE=N MODEL= BASEMODEL= CATEGORY= RECIPE= RECIPEVER= OPER= NW_CD= NW_DESCRIPTION=[] CHANGE_TYPE=B VALIDATIONINFO=[VALIDATIONINFO=[] UNIT_INFO=[%s:[7]:U:1:3:%s:0:[MODEL_NB#7^02MH01_D10000#LP140WU4-SPBA^PID#%s^%s_D10029#%f^02MH01_D10030#%f^02MH01_D10031#%f^02MH01_D10032#3]] REPLY_REQ=Y TO_EQP= MMC_TXN_ID="),*/
	m_strERCP.Format(_T("ERCP ADDR=%s,%s EQP=%s MACHINE=%s UNIT=%s RCS=H MODE_CODE=N MODEL= BASEMODEL= CATEGORY= RECIPE= RECIPEVER= OPER= NW_CD= NW_DESCRIPTION=[] CHANGE_TYPE=B VALIDATIONINFO=[] UNIT_INFO=[%s:[1]:U:1:3:%s:0:[%s]] REPLY_REQ=Y TO_EQP= MMC_TXN_ID="),
